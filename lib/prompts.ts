...
PROCESS:
1. Identify all entries in the JSON data related to the target brand and its competitors, if competitor_name is the same as original_brand means it's original_brand data
